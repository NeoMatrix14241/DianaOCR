...
class QwenVLOCRProcessor:
    ...
    def __init__(self, model_name: str = "Qwen/Qwen2-VL-7B-Instruct", device: str = "auto"):
        ...
        Args:
            model_name: Hugging Face model name for Qwen 2.5VL
    ...
    def extract_text(self, image: Image.Image, prompt: str = "Extract all text from this image accurately. Maintain formatting and structure.") -> str:
        """
...
class BatchOCRManager:
    ...
    def __init__(self, input_dir: str, output_dir: str, max_workers: int = None):
        ...
        self.ocr_processor = QwenVLOCRProcessor()
